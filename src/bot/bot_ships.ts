import { Ship } from '../db/db';

// yes, i'll replace it with random generator if i have time. but now i don't
export const botShips: Ship[][] = [
  [
  ...
  [
    { position: { x: 8, y: 4 }, direction: true, type: 'huge', length: 4 },
    {
      position: { x: 1, y: 3 },
      direction: false,
      type: 'large',
  ...
  [
    { position: { x: 4, y: 1 }, direction: true, type: 'huge', length: 4 },
    {
      position: { x: 0, y: 0 },
      direction: false,
      type: 'large',
    ...
    { position: { x: 7, y: 2 }, direction: true, type: 'large', length: 3 },
    {
      position: { x: 0, y: 6 },
      direction: true,
      type: 'medium',
    ...
    { position: { x: 4, y: 6 }, direction: true, type: 'small', length: 1 },
  ...
  [
    { position: { x: 1, y: 1 }, direction: true, type: 'huge', length: 4 },
    { position: { x: 7, y: 0 }, direction: true, type: 'large', length: 3 },
    { position: { x: 3, y: 3 }, direction: true, type: 'large', length: 3 },
    {
      position: { x: 6, y: 8 },
      direction: false,
      type: 'medium',
